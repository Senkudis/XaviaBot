...
export const config = {
    ...
    credits: "Diyakd",
    description: "في حال لديك رسالة طويلة.   اكتبها على جبهة ساكورا",
    usage: "[text]",
    cooldown: 10,
};
...
export async function onCall({ message, args }) {
    try {
        ...
        if (!text) return message.reply("أكتب المحتوى المراد عرضه على الصورة. ");

        await global.downloadFile(pathImg, "https://i.ibb.co/8KNhwq9/xva213.jpg");
